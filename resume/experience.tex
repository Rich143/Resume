    ...
    {}
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Developed driver to provide MP4 encoded stream from IP camera}
          % by modifying the multimedia graph
        ...
        %\item {Improved code to be safety certifiable by replacing dynamic memory allocation during runtime with static buffer arrays}
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {}
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        %\item {Together, tests and debug data add framework for greatly improving EFI development where none existed previously}
...
%---------------------------------------------------------
  %\cventryOneLine
    ...
    %{Hardware Design Intern} % Job title
